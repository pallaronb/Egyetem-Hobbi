...
#
# Automatic tests for Homework#1 in ELTE IK, ANN BSc course part1, 2026 spring
#
...
class Tester:
    ...
    def get_dataset_content(self):
        ...
        if self.dataset_content is None:
            url = "https://nipg12.inf.elte.hu/~vavsaai@nipg.lab/annbsc26_p1/files/student-mat_prep_noisy26hw1.csv"
